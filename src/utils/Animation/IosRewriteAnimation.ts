...
const getIonPageElement = (element: any) => {
...
const DURATION = 540;
const getClonedElement = (tagName: any) => {
...
const getBackButton = (refEl: any, backDirection: any) => {
    const tabs = refEl.tagName === 'ION-TABS' ? refEl : refEl.querySelector('ion-tabs');
    let buttonsList = [];
    if (tabs != null) {
        const activeTab = tabs.querySelector('ion-tab:not(.tab-hidden), .ion-page:not(.ion-page-hidden)');
...
const createLargeTitleTransition = (rootAnimation: any, rtl: any, backDirection: any, enteringEl: any, leavingEl: any) => {
...
const animateBackButton = (rootAnimation: any, rtl: any, backDirection: any, backButtonEl: any, largeTitleBox: any, backButtonBox: any) => {
    ...
    const clonedBackButtonEl = getClonedElement('ion-back-button') as any;
...
const animateLargeTitle = (rootAnimation: any, rtl: any, backDirection: any, largeTitleEl: any, largeTitleBox: any, backButtonBox: any) => {
    ...
    const clonedTitleEl = getClonedElement('ion-title') as any;
...
export const iosRewriteAnimation = (navEl: any, opts: any) => {
    ...
    enteringToolBarEls.forEach((enteringToolBarEl: any) => {
        ...
        let buttonsToAnimate: any;
        if (backDirection) {
            buttonsToAnimate = buttons.filter((button: any) => {
                const isCollapseButton = button.classList.contains('buttons-collapse');
                return (isCollapseButton && !inactiveHeader) || !isCollapseButton;
            });
        } else {
            buttonsToAnimate = buttons.filter((button: any) => !button.classList.contains('buttons-collapse'));
        }
    ...
    if (leavingEl) {
        ...
        leavingToolBarEls.forEach((leavingToolBarEl: any) => {
            ...
            const inactiveHeader = parentHeader === null || parentHeader === void 0 ? void 0 : parentHeader.classList.contains('header-collapse-condense-inactive');
            const buttonsToAnimate: any = Array.from(buttons).filter((button: any) => {
                const isCollapseButton = button.classList.contains('buttons-collapse');
                return (isCollapseButton && !inactiveHeader) || !isCollapseButton;
            });
